...
import { BUSINESS_CATEGORIES, CATEGORIES } from '@/utils/constants';
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const normal = normalizeText(slug);
    const data = [...CATEGORIES,...BUSINESS_CATEGORIES];
    const heading =
      data.find((item) => item.card_title === normal)?.heading ||
      'Heading';
    const description =
      data.find((item) => item.card_title === normal)?.description ||
      'Description';
            ...
            <div className={'flex flex-col items-start text-start gap-4 mt-10'}>
              <div className={'flex items-center gap-3'}>
                ...
                <div className={'flex flex-col items-start text-start'}>
                  <span className={'text-[16px] font-semibold text-[#13519C]'}>
                    Customer Care
                  </span>
                  <span
