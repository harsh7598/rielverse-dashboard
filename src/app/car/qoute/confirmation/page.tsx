    ...
    <div className='w-full bg-gradient-to-b from-[#BCCEE4] to-transparent h-96 to bg-white'>
      ...
      <div className='w-full h-auto max-w-[1300px] px-8 flex flex-col md:flex-row gap-4 mx-auto pt-20 md:pt-40'>
        ...
        <div className='w-full md:w-3/4 bg-gradient-to-b from-[#1A45D6] to-white rounded-[10px] p-[1px] flex flex-col '>
          <div className='bg-white z-10 rounded-[11px] p-4 md:p-8 lg:p-12'>
            <div className='flex flex-col gap-2 mb-6 md:mb-10'>
              <h2 className='text-[16px] md:text-[20px] lg:text-[24px] font-bold'>Confirmation</h2>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10'>
              {[
                ...
                <div key={idx} className='flex flex-col'>
                  <label className='font-semibold text-[13px] md:text-[14px] lg:text-[16px] pb-1'>
                    {field.label}
                  </label>
                  <p className='text-[8px] md:text-[10px] pb-1'>Need Help ?</p>
                  <input
                    type={field.type}
                    placeholder={field.placeholder}
                    className='text-[12px] md:text-[16px] border border-blue-600 rounded-lg p-2 mt-1 focus:ring-2 focus:ring-blue-400 outline-none'
                  />
                </div>
              ))}
              ...
              <div className='flex flex-col'>
                ...
                <div className='relative'>
                  <select
                    className='text-[12px] md:text-[16px] w-[110px] appearance-none border border-blue-600 rounded-lg p-2 mt-1 focus:ring-2 focus:ring-blue-400 outline-none w-full'
                    style={{
        ...
        <div className='w-full min-w-[250px] md:min-w-[300px] md:w-1/4 z-10 h-fit bg-gradient-to-b from-[#1A45D6] to-white rounded-[10px] p-[1px]'>
          <div className='bg-white z-10 rounded-[11px] p-4 md:p-8'>
            <div className='flex justify-between'>
              <div className='flex flex-col gap-3'>
                <p className='text-[14px] md:text-[16px] lg:text-[18px] font-semibold'>Policy Details</p>
                <p className='text-[14px] md:text-[16px] lg:text-[18px] font-semibold text-[#102770]'>
                  Comprehensive
                </p>
              </div>
              <div className='flex items-center justify-center'>
                <span className='font-semibold text-lg md:text-xl lg:text-2xl'>$300</span>
              </div>
            </div>
            <div className='border-2 border-gray-400 border-dashed mt-2'></div>
            <div className='pt-4'>
              <div className='flex justify-between pb-[100px]'>
                <p className='text-[12px] md:text-[14px]'>Comprehensive</p>
                <p className='text-[12px] md:text-[14px]'>$300</p>
              </div>
            </div>
            <div className='border-2 border-gray-400 border-dashed mt-2'></div>
            <div className='pt-4 flex flex-col gap-4 pb-6'>
              <div className='flex justify-between'>
                <p className='text-[12px] md:text-[14px]'>Sub-total</p>
                <p className='text-[12px] md:text-[14px]'>$300</p>
              </div>
              <div className='flex justify-between'>
                <p className='text-[12px] md:text-[14px]'>+ Admin Fee</p>
                <p className='text-[12px] md:text-[14px]'>$1</p>
              </div>
            </div>
            <div className='flex flex-col gap-3'>
              <div className='flex justify-between text-sm md:text-md lg:text-lg font-bold'>
              ...
              <div className='flex flex-col gap-2'>
                <Dialog>
                  <DialogTrigger asChild>
                    <Button
                      className='flex items-center justify-between w-[175px] h-[40px] px-4 py-2 bg-[#13519C] text-white text-[10px] md:text-[12px] rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2'
                      style={{
                ...
                <p className='text-[8px] md:text-[10px]'>Get your policy online instantly!</p>
              </div>
            </div>
          </div>
        </div>
