...
const PrivacyPolicy = () => {
  return (
    <div className='w-full'>
      ...
      />
      <Header />
      <div className='w-full h-auto mx-auto max-w-[1300px] flex flex-col md:flex-row gap-10 justify-center pt-40 px-4 md:px-8 sm:px-1 lg:px-16 mb-44'>
        {/* {left section} */}
        <div className='w-full md:w-4/6 flex flex-col'>
          <h2 className='text-xl font-semibold mb-4'>Privacy Policy</h2>
          <h2 className='text-xl font-semibold mb-4'>Rielverse</h2>
          ...
          <p className='text-[14px] mb-4'>Internal record keeping.</p>
          <p className='text-[14px] mb-4'>
        ...
        <div className='w-full md:w-2/6 z-10 h-fit bg-gradient-to-b from-[#1A45D6] to-white rounded-[10px] p-[1px]'>
          <div className='flex flex-col gap-4  bg-white z-10 rounded-[11px] p-4 md:p-8'>
            ...
            <div className='flex flex-col gap-2'>
              <h3 className='text-[18px] font-semibold text-[#1A45D6]'>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <p className='text-[14px]'>complaint@rielverse.com</p>
            </div>
            <div className='flex flex-col gap-2'>
              <h3 className='text-[18px] font-semibold text-[#1A45D6]'>
                Post To
