      ...
      <div className={"w-full h-auto p-[1px] bg-white z-10 rounded-[11px]"}>
        ...
        >
          ...
          >
            <div
              className={
                "max-[1150px]:w-full flex flex-col items-start text-start mt-4"
              }
            >
              <span className={"text-[18px] md:text-[22px] lg:text-[24px] font-semibold"}>
                About <br /> Rielverse
              </span>
              ...
              <span
                ...
                className={
                  "text-[14px] md:text-[16px] lg:text-[18px] max-[1150px]:w-full min-[1150px]:w-[500px] mt-5"
                }
              >
            ...
            <div className={"flex relative"}>
              <Image
                ...
                alt="diamond"
                className={
                  "max-w-[238px] max-h-[175px] max-[1150px]:max-w-[139px] max-[1150px]:max-h-[78px] object-contain absolute max-[1150px]:-bottom-2 -bottom-14 max-[1150px]:-left-10 -left-32"
                }
                width={238}
                height={175}
              />
              <Image
                ...
                alt="colleges"
                className={
                  "max-w-[339px] max-h-[226px] max-[1150px]:max-w-[240px] max-[1150px]:max-h-[166px] object-contain rounded-xl"
                }
                width={339}
                height={226}
              />
          ...
          <div className={"w-full flex flex-col items-start text-start"}>
            <span className={"text-[18px] md:text-[22px] lg:text-[24px] max-w-[550px] font-semibold"}>
            ...
            <span
              style={{ fontFamily: "Arboria-Book", fontWeight: 400 }}
              className={"text-[14px] md:text-[16px] lg:text-[18px] mt-5"}
            >
          ...
          >
            <div className={"px-2 min-w-[300px] h-[450px]"}>
              <div
                className={
                  "w-full h-full block border-2 rounded-2xl overflow-visible border-[#13519C]/50 hover:border-[#13519C] duration-300"
                }
              >
                <Image
                  src={layer}
            ...
            <div className={"flex flex-col items-start text-start mt-7"}>
              <span className={"text-[18px] md:text-[22px] lg:text-[24px] max-w-[550px] font-semibold"}>Our Mission</span>
              ...
              <span className={"text-[18px] md:text-[22px] lg:text-[24px] max-w-[550px] mt-7 font-semibold"}>Our Vision</span>
          ...
          <p
            style={{ fontFamily: "Arboria-Book", fontWeight: 400 }}
            className={"text-[14px] md:text-[16px] lg:text-[18px] text-start"}
          >
